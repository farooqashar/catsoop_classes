...
cs_header = '6.Flask'  # the upper-left corner
cs_icon_url = 'COURSE/logo.png'  # the favicon, if any
# the 'header' text for the page
cs_long_name = cs_content_header = "Flask Course"
cs_title = '6.Flask'  # the browser's title bar
...
cs_top_menu = [
    ...
    #                           ]},
   {'text': 'Lessons', 'link': [
                                    {'link': 'COURSE/intro', 'text': 'Introduction'},
                                    {'link': 'COURSE/routing', 'text': 'Routing'},
                                    {'link': 'COURSE/templates', 'text' : 'Templates'},
                                    {'link': 'COURSE/static', 'text' : 'Static Files'},
                                    {'link': 'COURSE/forms', 'text' : 'Flask Forms'},
                                    ]},
                                       {'text': 'Exercises', 'link': [
                                    {'link': 'COURSE/routingquestions', 'text': 'Routing'},
                                    {'link': 'COURSE/templatesquestions', 'text' : 'Templates'},
                                    {'link': 'COURSE/staticquestions', 'text' : 'Static Files'},
                                    {'link': 'COURSE/formsquestions', 'text' : 'Flask Forms'},
                                    ]},
   {'text': 'Flask Documentation', 'link': 'https://flask.palletsprojects.com/en/2.0.x/'},
]
