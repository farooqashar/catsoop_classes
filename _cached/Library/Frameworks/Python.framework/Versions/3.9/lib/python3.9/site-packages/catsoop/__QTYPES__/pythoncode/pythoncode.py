import sys
_orig_path = sys.path
if '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/catsoop/__QTYPES__/pythoncode' not in sys.path:
    sys.path = ['/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/catsoop/__QTYPES__/pythoncode'] + sys.path
...
def render_html_textarea(last_log, **info):
    return tutor.question(globals(),"bigbox")[0]["render_html"](last_log, **info)
