import sys
_orig_path = sys.path
if '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/catsoop/__QTYPES__/pythonic' not in sys.path:
    sys.path = ['/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/catsoop/__QTYPES__/pythonic'] + sys.path
...
base1, _ = tutor.question(globals(),"pythoncode")
